...
void I2C_Configuration(void)
{
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_OD;//必须复用开漏输出
	GPIO_Init(GPIOB, &GPIO_InitStructure);

	I2C_DeInit(I2C1);
	I2C_InitStructure.I2C_Mode = I2C_Mode_I2C;//I2C模式
	I2C_InitStructure.I2C_DutyCycle = I2C_DutyCycle_2;//快速模式才有意义
	I2C_InitStructure.I2C_OwnAddress1 = 0x30;//随便写，本机地址
	I2C_InitStructure.I2C_Ack = I2C_Ack_Enable;//使能应答
	I2C_InitStructure.I2C_AcknowledgedAddress = I2C_AcknowledgedAddress_7bit;//7位从机地址
